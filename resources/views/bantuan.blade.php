    ...
    <div class="row block-12 ">
        <div class="col-md-12 order-md-last d-flex align-items-center justify-content-center">
            <form action="#" class="bg-white p-5 contact-form">
                ...
                <div class="form-group">
                <input type="text" class="form-control" placeholder="Jenis bantuan">
                </div>
                <div class="form-group">
                <input type="text" class="form-control" placeholder="KK">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="IMLK">
                </div>
                <div class="form-group">
                <textarea name="" id="" cols="30" rows="7" class="form-control" placeholder="Keterangan"></textarea>
                </div>
                <div class="form-group">
                <input type="submit" value="Ajukan Bantuan" class="btn btn-primary py-3 px-5">
                </div>
            </form>
        </div>
    </div>
